...
export default function AdminProductNew() {
    ...
    const [sizes, setSizes] = useState([{ name: "Nhỏ", price: "" }, { name: "Vừa", price: "" }]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newId = String(
            Math.max(0, ...products.map((p) => parseInt(p.id) || 0)) + 1
        );
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="VD: Hoa Hồng Pastel"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="VD: Bó hồng pastel ngọt ngào"
                            className={inputClass}
                        />
                    </div>
