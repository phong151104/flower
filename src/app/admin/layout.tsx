            ...
            <div className="flex-1 flex flex-col min-h-screen">
                ...
                <header className="h-16 bg-gray-900/80 backdrop-blur-sm border-b border-gray-800 flex items-center justify-between px-6 sticky top-0 z-30">
                    ...
                    <div className="hidden lg:block">
                        ...
                        <p className="font-semibold">Chủ tiệm hoa 🌸</p>
                    </div>
                    <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-sm font-bold">
                            A
                        </div>
                    </div>
                </header>
